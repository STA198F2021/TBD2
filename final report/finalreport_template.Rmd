...
=======
>>>>>>> 5d049f08b897393dfa031f92b3035e06ded2e191
```{r}
merged_5_states%>%
  filter(YEAR == 2020)%>%
...
The results of the linear model indeed support our initial hypothesis that the number of influenza infection is highly related to the COVID-19 restrictions. 
=======
